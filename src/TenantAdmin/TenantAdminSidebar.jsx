...
const navigationItems = [
  { id: "overview", label: "Tenant Overview", path: "/tenant/overview", icon: LayoutDashboard },
  { id: "hospitals", label: "Hospitals", path: "/tenant/hospitals", icon: Hospital },
  { id: "procedures", label: "Master Procedures", path: "/tenant/procedures", icon: Clipboard },
...
export default function TenantAdminSidebar({ isOpen, onClose, isCollapsed, onToggleCollapse, tenantInfo }) {
  ...
  const visibleNavItems = navigationItems.filter(item => {
    if (item.isSuperAdminOnly && !showSupportTickets) return false;
    return true;
  });
