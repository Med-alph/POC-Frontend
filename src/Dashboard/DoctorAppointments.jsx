                    ...
                    {appointments.map((appt) => (
                        <div
                            ...
                            className="flex justify-between items-center p-4 rounded-xl cursor-pointer transition-all 
                                ...
                                border-2 border-blue-200 dark:border-blue-800 hover:shadow-md hover:scale-[1.02]"
                        >
                            ...
                            <span className={`text-xs font-bold px-3 py-1.5 rounded-full ml-3 shadow-sm ${getStatusColor(appt.status)}`}>
                    ...
                    <div className="relative z-50 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md border border-gray-200 dark:border-gray-700 animate-in fade-in-0 zoom-in-95">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600">
                                ...
                                <span className={`text-xs font-bold px-3 py-1.5 rounded-full ${getStatusColor(selectedAppointment.status)}`}>
