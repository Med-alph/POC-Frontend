      ...
      <main className="flex-1 p-2 sm:p-6">
        ...
        <div className="mt-2 sm:mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 px-1 sm:px-6">
          ...
          <div className="bg-white rounded-lg shadow p-3 sm:p-5 border-l-4 border-blue-500">
            ...
            <p className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-3">24</p>
          ...
          <div className="bg-white rounded-lg shadow p-3 sm:p-5 border-l-4 border-green-500">
            ...
            <p className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-3">8</p>
            <p className="text-xs sm:text-sm font-medium text-green-500 mt-1">+15% from yesterday</p>
          </div>

          {/* Card 3 - Cancellations */}
          <div className="bg-white rounded-lg shadow p-3 sm:p-5 border-l-4 border-red-500">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
            ...
            <p className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-3">3</p>
          ...
          <div className="bg-white rounded-lg shadow p-3 sm:p-5 border-l-4 border-purple-500">
            ...
            <p className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-3">12</p>
        ...
        <div className="mt-4 sm:mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 px-1 sm:px-6">
          ...
          <div className="bg-white rounded-lg shadow p-3 sm:p-6 h-64 sm:h-80 flex flex-col">
          ...
          <div className="bg-white rounded-lg shadow p-3 sm:p-6 h-64 sm:h-80 flex flex-col items-center justify-start">
