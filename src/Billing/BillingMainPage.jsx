...
export default function BillingPage() {
  ...
  const patient = { name: "John Doe", age: 32, phone: "+91-9876543210", email: "johndoe@example.com", address: "123 MG Road, City" ,id: "1142c1d8-99cf-4fcd-8467-262cc15e4368"};
  const items = [
  ...
  try {
    ...
    setRazorpayOrderId(orderResponse.orderNumber || orderResponse.razorpayOrderId);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="billing" onValueChange={setActiveTab} className="mt-6">
          ...
          <TabsContent value="payment" className="mt-6">
            <PaymentTab
              ...
              onPaymentSuccess={() => {
                ...
                // Optional: reset form or refetch data
              }}
            />
          </TabsContent>
        </Tabs>
