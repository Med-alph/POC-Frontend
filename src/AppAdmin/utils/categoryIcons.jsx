...
// Category icon utility for consistent icons across the app
...
export const getCategoryColor = (category) => {
  const colors = {
    ...
    developer: 'bg-yellow-50 border-yellow-200',
    other: 'bg-gray-50 border-gray-200'
  };
  return colors[category?.toLowerCase()] || 'bg-gray-50 border-gray-200';
};
