...
// Tier icon utility for consistent icons across the app
...
export const getTierColor = (tier) => {
  ...
  return colors[tier?.toLowerCase()] || 'bg-gray-50 text-gray-700 border-gray-200';
};

export const getTierIconColor = (tier) => {
  const colors = {
  ...
  return colors[tier?.toLowerCase()] || 'text-gray-600';
};