...
const SelectablePlanPreview = ({ plan, features, isSelected, onSelect }) => {
  ...
  return (
    <div className="w-full h-full relative">
      ...
      {/* Plan Card Preview */}
      <div 
        className={`w-full h-full bg-white border-2 rounded-xl shadow-lg overflow-hidden flex flex-col cursor-pointer transition-all duration-300 ${
          isSelected ? 'border-blue-500 ring-4 ring-blue-100' : 'border-gray-200 hover:border-gray-300 hover:shadow-xl'
        }`}
        onClick={onSelect}
      >
        ...
        <div className="px-6 py-6 bg-gray-50 mt-auto">
          ...
          >
            {isSelected ? 'Selected' : `Choose ${plan.name || 'This Plan'}`}
          </Button>
        </div>
      </div>
    </div>
...
export default SelectablePlanPreview;